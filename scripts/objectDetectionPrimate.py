...
if __name__ == "__main__":
    ...
    model_path = 'NonHumanPrimateProject/TFLiteAssets/primate.tflite'
    label_path = 'NonHumanPrimateProject/TFLiteAssets/detection_labels.txt'
    image_path = 'NonHumanPrimateProject/TFLiteAssets/train/beagle0.jpg'
