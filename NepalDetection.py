...
#setup for detecting new photos
path = r"C:\Users\bazariann\Documents\MonkeyDeepLearnModel\FakeCamera"
pictureCount = 0
#setup text message system
yag = yagmail.SMTP('primatedetection@gmail.com', 'uihagmrtcliffnym' )
    ...
    if (pictureCount != 0):
        ...
        for x in os.listdir(path):
            if x.endswith(".jpg"):
                ...
                print("Text message system connected.\n")

            #Run object detection and show the detection results
                from PIL import Image
                DETECTION_THRESHOLD = 0.5 
                
                photoDetected = 'C:\\Users\\bazariann\\Documents\\MonkeyDeepLearnModel\\FakeCamera\\' + x
                
                im = Image.open(photoDetected)
